...
(function initSettingsI18n(root) {
  const STRINGS = {
    en: {
      ...
      remoteSshFieldHostPrefixHint: "Short name shown in Sessions menu. ASCII letters, digits, dots, hyphens; no quotes / shell metacharacters.",
    ...
    zh: {
      ...
      remoteSshFieldHostPrefixHint: "在 Sessions 菜单显示的简短名称。仅 ASCII 字母数字、点、连字符；不允许引号或 shell 元字符。",
    ...
    ko: {
      ...
      remoteSshFieldHostPrefixHint: "Sessions 메뉴에 표시되는 짧은 이름. ASCII 문자/숫자/점/하이픈만 허용; 따옴표나 셸 메타문자는 사용 불가.",
    ...
    ja: {
      ...
      remoteSshFieldHostPrefixHint: "Sessions メニューに表示される短い名前。ASCII の英数字 / ドット / ハイフンのみ；引用符やシェルメタ文字は不可。",
